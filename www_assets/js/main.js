...
/* harmony export */   setRefreshTimer: () => (/* binding */ setRefreshTimer),
/* harmony export */   timerSwitcher: () => (/* binding */ timerSwitcher)
/* harmony export */ });
...
let cssAdded = 0;
const timerSwitcher = () => {
    _utils__WEBPACK_IMPORTED_MODULE_0__["default"].clck(_utils__WEBPACK_IMPORTED_MODULE_0__["default"].q('.timebar_controls > li'), function(e){
        if (this.classList.contains('timer_stop')){
            let bar = _utils__WEBPACK_IMPORTED_MODULE_0__["default"].q('.animated-bar');
            if (bar.length){
                bar[0].remove();
            }
            js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].set('timerStopped',1)
            clearTimeout(timerTimeout)
            document.body.classList.add('timerStopped')
        } else {
            js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].set('timerStopped',0)
            setRefreshTimer();
...
const setRefreshTimer = () => {
    ...
    const listItems = _utils__WEBPACK_IMPORTED_MODULE_0__["default"].q('.menu > li a');
    ...
    if (js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].get('timerStopped') == '1') {
        document.body.classList.add('timerStopped')
        return;
    }
    ...
    if (!cssAdded){
        ...
        _utils__WEBPACK_IMPORTED_MODULE_0__["default"].CSS(cssAddition);
        cssAdded=1;
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   clck: () => (/* binding */ clck),
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _refresh_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./refresh_page */ "./src/refresh_page.js");
...
//  refresh()
  (0,_refresh_page__WEBPACK_IMPORTED_MODULE_0__.setRefreshTimer)();
  (0,_refresh_page__WEBPACK_IMPORTED_MODULE_0__.timerSwitcher)();
  (0,_utils__WEBPACK_IMPORTED_MODULE_1__.q)('.news').forEach(li => {
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.clck)(li, function (e) {
      e.preventDefault()
  ...
  ;(0,_utils__WEBPACK_IMPORTED_MODULE_1__.q)('.article_body').forEach(a => {
    ;(0,_utils__WEBPACK_IMPORTED_MODULE_1__.clck)(a, function (e) {
      e.stopPropagation()
    })
  })

  ;(0,_utils__WEBPACK_IMPORTED_MODULE_1__.q)('.expand_button').forEach(b => {
    ;(0,_utils__WEBPACK_IMPORTED_MODULE_1__.clck)(b, function () {
      this.classList.add('hidden')
      const newsBlock = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parents)(this, '.news_block').pop()
  ...
  // hamburger
  ;(0,_utils__WEBPACK_IMPORTED_MODULE_1__.clck)((0,_utils__WEBPACK_IMPORTED_MODULE_1__.q)('#hamburger')[0], function () {
    ;(0,_utils__WEBPACK_IMPORTED_MODULE_1__.q)('#menu-small')[0].classList.toggle('show')
  });

  // scroll to top button
  (function () {
    const scrollToTopBtns = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.q)('#scrollToTopBtn')
